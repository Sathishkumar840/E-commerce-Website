...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4 '>
        ...
        <div className='h-96 flex flex-col lg:flex-row-reverse gap-4 p-2'>
          ...
          <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative'>
            <img src={activeImage} className='h-full w-full object-scale-down mix-blend-multiply ' onMouseMove={handleZoomImage} onMouseLeave={handleLeaveImageZone} alt="" />
            {/* product zoom */}

            {
              zoomImage && (
                <div className=' hidden lg:block absolute min-w-[500px] min-h-[400px] overflow-hidden bg-slate-200 p-1 -right-[510px] top-0'>
                  <div className='w-full h-full min-h-[400px] min-w-[500px] bg-slate-200 scale-150  mix-blend-multiply'
                    style={{
      ...
      {
        data?.category && (
          <CategoryWiseProductDisplay category={data?.category} heading={"Recommanded products..."}/>
        )
      }
