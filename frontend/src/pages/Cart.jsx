                ...
                <div className='w-full max-w-3xl'>
                    {
                        ...
                        loading ? (
                            loadingCart.map((el,index) => {
                                return (
                                    <div key={el + "AddTo Cart Loading"+index} className=' w-full bg-slate-200 h-32 my-2 border border-slate-300 animate-pulse rounded'>
                            ...
                            (
                                ...
                                data.map((product, index) => {
                                    return (
                                        <div key={product?._id} className=' w-full bg-white h-32 my-2 border border-slate-300 grid grid-cols-[128px,1fr] rounded'>

                                            <div className='w-32 h-32 bg-slate-200 p-3 object-fill'>
                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                    {
                        loading ? (
                            ...
                            <div className="h-36 bg-white">
                                <h2 className='bg-red-600 text-white flex items-center justify-center px-4 py-2'>Summary</h2>
